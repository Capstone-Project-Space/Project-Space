...
TestResult* NM_TestNoiseMapDefaultConstructor() {
     TestResult* result = new TestResult{ "Noise Map Default Contructor" };
...
TestResult* NM_TestNoiseMapCustomConstructor() {
     TestResult* result = new TestResult{ "Noise Map Custom Contructor" };
...
TestResult* NM_TestNoiseMapDestructor() {
     TestResult* result = new TestResult{ "Noise Map Detructor" };
     NoiseMap* nm = new NoiseMap();
     delete nm;
...
TestResult* NM_TestNoiseMapGetterSetter() {
     TestResult* result = new TestResult{ "Noise Map Getters and Setters" };
     NoiseMap* nm = new NoiseMap;
...
TestResult* NM_TestNoiseMapGeneration() {
     TestResult* result = new TestResult{ "Noise Map Generation" };
